#ifndef MUDUO_HTTP_FAST_CGI_SPEC_H
#define MUDUO_HTTP_FAST_CGI_SPEC_H
/**
 *
 * come code from https://github.com/Miaoshuai/fastcgi
 *
 */
...
//webserver期望应用扮演的角色
#define FCGI_KEEP_CONN  1       //如果为0则处理完请求应用就关闭，否则不关闭  used for flags
...
#endif // MUDUO_HTTP_FAST_CGI_SPEC_H
